        ...
        const fetchProduct = async () => {
            try {
                const { data, error } = await supabase
                    ...
                    .select("*")
                    .eq("id", id)
                    .single(); // Ambil hanya satu produk
            ...
            <div className="container my-5 produk-detail">
                <div className="row">
                    <div className="col-md-4">
                        <img
                            src={product.imageUrl} // URL gambar produk
                            alt={product.name}
                            className="img-fluid"
                        />
                    </div>
                    <div className="col-md-8">
                        ...
                        <a
                            href={`https://api.whatsapp.com/send/?phone=6283134339542&text=Hello! I am interested in your product, ${product.name}.`}
